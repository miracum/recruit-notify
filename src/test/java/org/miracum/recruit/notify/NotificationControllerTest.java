...
class NotificationControllerTest {
  ...
  private static final String screeningListReferenceSystem =
      "http://miracum.org/fhir/screening-list-study-reference";
  @Mock private JavaMailSender javaMailSender;
  @Mock private FhirServerProvider fhirServer;
  ...
  public void setUp() {
    ...
    screeningList.addExtension(
        screeningListReferenceSystem, new Reference("ResearchStudy/0").setDisplay("TEST"));
  ...
  void onListChange_withMatchingNotificationRule_shouldSendEmail() {
    List<MailNotificationRule> rules =
        List.of(
            new MailNotificationRule() {
              {
                setAcronym("TEST");
